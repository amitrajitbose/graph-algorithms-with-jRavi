...
def spanning_tree(graph, source):
	...
	# first 
	priority_queue = priority_dict.priority_dict() # priority of a node is
	# the weight of an edge attached to the node 
	priority_queue[source] = 0 # priority of source set to zero
	...
	while len(priority_queue.keys()) > 0:
		current_vertex = priority_queue.pop_smallest() # highest priority
...
print("Start At Node 1\n")
spanning_tree(g, 1)
print("Start At Node 3\n")
spanning_tree(g, 3)
